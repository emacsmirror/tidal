...
pDouble_pC =
    Map.fromList
        ...
        , ("fmr", T.pF "fmr")
        , ("am", T.pF "am")
        , ("amdepth", T.pF "amdepth")
        , ("rm", T.pF "rm")
        , ("rmdepth", T.pF "rmdepth")
        , ("phaser", T.pF "phaser")
        , ("phaserdepth", T.pF "phaserdepth")
        , ("phasersweep", T.pF "phasersweep")
        , ("phasercenter", T.pF "phasercenter")
        , ("flanger", T.pF "flanger")
        , ("flangerdepth", T.pF "flangerdepth")
        , ("flangerfeedback", T.pF "flangerfeedback")
        , ("chorus", T.pF "chorus")
        , ("chorusdepth", T.pF "chorusdepth")
        , ("chorusdelay", T.pF "chorusdelay")
        , ("coarse", T.pF "coarse")
        , ("crush", T.pF "crush")
        , ("distort", T.pF "distort")
        , ("distortvol", T.pF "distortvol")
        , ("delay", T.pF "delay")
        , ("delaytime", T.pF "delaytime")
        , ("delayfeedback", T.pF "delayfeedback")
        , ("verb", T.pF "verb")
        , ("verbdecay", T.pF "verbdecay")
        , ("verbdamp", T.pF "verbdamp")
        , ("verbpredelay", T.pF "verbpredelay")
        , ("verbdiff", T.pF "verbdiff")
        ]
