...
(defun tidal-mode-keybindings (map)
  ...
  (keymap-set map "C-c C-h" #'tidal-hush)
  ...
  (keymap-set map "C-c C-0" #'tidal-run-d10)
  ...
  (keymap-set map "C-c C-0" #'tidal-stop-d10))

(defun tidal-turn-on-keybindings ()
  "Haskell Tidal keybindings in the local map."
  (keymap-local-set "C-c C-s" #'tidal-start-haskell)
  (keymap-local-set "C-c C-v" #'tidal-see-output)
  (keymap-local-set "C-c C-q" #'tidal-quit-haskell)
  (keymap-local-set "C-c C-c" #'tidal-run-line)
  (keymap-local-set "C-c C-e" #'tidal-run-multiple-lines)
  (keymap-local-set "C-<return>" #'tidal-run-multiple-lines)
  (keymap-local-set "C-c C-r" #'tidal-run-region)
  (keymap-local-set "C-c C-l" #'tidal-load-buffer)
  (keymap-local-set "C-c C-i" #'tidal-interrupt-haskell)
  (keymap-local-set "C-c C-m" #'tidal-run-main)
  (keymap-local-set "C-c C-h" #'tidal-hush)
  (keymap-local-set "C-c C-1" #'tidal-run-d1)
  (keymap-local-set "C-c C-2" #'tidal-run-d2)
  (keymap-local-set "C-c C-3" #'tidal-run-d3)
  (keymap-local-set "C-c C-4" #'tidal-run-d4)
  (keymap-local-set "C-c C-5" #'tidal-run-d5)
  (keymap-local-set "C-c C-6" #'tidal-run-d6)
  (keymap-local-set "C-c C-7" #'tidal-run-d7)
  (keymap-local-set "C-c C-8" #'tidal-run-d8)
  (keymap-local-set "C-c C-9" #'tidal-run-d9)
  (keymap-local-set "C-c C-0" #'tidal-run-d10)
  (keymap-local-set "C-v C-1" #'tidal-stop-d1)
  (keymap-local-set "C-v C-2" #'tidal-stop-d2)
  (keymap-local-set "C-v C-3" #'tidal-stop-d3)
  (keymap-local-set "C-v C-4" #'tidal-stop-d4)
  (keymap-local-set "C-v C-5" #'tidal-stop-d5)
  (keymap-local-set "C-v C-6" #'tidal-stop-d6)
  (keymap-local-set "C-v C-7" #'tidal-stop-d7)
  (keymap-local-set "C-v C-8" #'tidal-stop-d8)
  (keymap-local-set "C-v C-9" #'tidal-stop-d9)
  (keymap-local-set "C-v C-0" #'tidal-stop-d10))
...
(define-derived-mode
  ...
  "Haskell Tidal"
  "Major mode for interacting with an inferior haskell process."
  :after-hook (interactive-haskell-mode -1)
  (set (make-local-variable 'paragraph-start) "\f\\|[ \t]*$")
  (set (make-local-variable 'paragraph-separate) "[ \t\f]*$")
